 ...
 */
static const char * const BAR_FONT = "-misc-fixed-medium-r-normal--14-110-100-100-c-70-iso8859-1";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#181512";
static const char * const WIN_FS_COLOR = "#000000";
static const char * const SEL_COLOR    = "#84A79E";
static const char * const BAR_BG_COLOR = "#1F1D1A";
static const char * const BAR_FG_COLOR = "#CCBBAA";
