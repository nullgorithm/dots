...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  ...
  hi CursorLine     term=none cterm=none ctermfg=none ctermbg=000
  hi CursorLineNr   term=none ctermfg=242 ctermbg=008 cterm=bold
  ...
  hi TabLine        term=none cterm=none ctermfg=234  ctermbg=008
  hi TabLineFill    term=none cterm=none ctermfg=234  ctermbg=008
  hi TabLineSel     term=none cterm=none ctermfg=008  ctermbg=234
  ...
  hi StatusLine     term=none ctermfg=234 ctermbg=008 cterm=bold
  hi StatusLineNC   term=none ctermfg=008 ctermbg=000 cterm=none
